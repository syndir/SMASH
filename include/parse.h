...
#define COMMAND_DELIMS      "|"         /* Delimiters for commands */
...
typedef struct command_s
{
    ...
    int append_stdout;          /* if we should append or truncate any 
...
{
    char *input;
    int is_background_command;  /* if input was specified to be a bg command */
